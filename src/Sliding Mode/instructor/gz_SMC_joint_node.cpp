...
//   · joint4: el residual de Coulomb entre la friccion discontinua de la
//     planta y el tanh del feedforward, dividido por su inercia diminuta
//     (M44 ~ 0.001 kg·m²), equivale a ~10-20 rad/s² de perturbacion.
//     Por eso K_S4 > K_S1..3 y Lambda4 alto (e_ss ~ s_ss/Lambda).
// ═══════════════════════════════════════════════════════════════════════════
static const Eigen::Vector4d LAMBDA_Q = {10.0, 10.0, 10.0, 15.0};   // superficie [1/s]
static const Eigen::Vector4d K_V      = { 8.0,  8.0,  8.0, 10.0};   // alcance exponencial (proporcional a s)
static const Eigen::Vector4d K_S      = { 3.0,  4.5,  4.5,  6.0};   // ganancia conmutacion rho(s) [rad/s²]
// ═══════════════════════════════════════════════════════════════════════════
